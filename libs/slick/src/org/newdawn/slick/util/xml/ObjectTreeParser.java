 ...
 * this several times in the past but in the projectile case it may not be perfect. Consider a custom
...
public class ObjectTreeParser {
	 ...
	 * only needed because the projectile reflection method is case
	 * sensitive
	 * 
