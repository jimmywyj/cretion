...
public class Shader {
    ...
    private Shader(ShaderResourceManager srm, Collection<String> vertex, Collection<String> fragment)
     ...
     * @throws SlickException
     */
    public static Shader makeShader(String vertexFileName, String fragmentFileName) throws SlickException {
     ...
     *
     * @param detailLevel
     *            number of characters to display for error messages.
     */
    ...
    /**
     * Returns true if this <tt>Shader</tt> has been deleted.
     *
     * @return true if this <tt>Shader</tt> has been deleted.
     */
    ...
    /**
     * Sets the value of the uniform integer Variable <tt>name</tt>.
     *
     * @param name
     *            the variable to set.
     * @param value
    ...
    private boolean linkedSuccessfully() {
        ...
        return true;
        // return GL20.glGetShader(programID,
