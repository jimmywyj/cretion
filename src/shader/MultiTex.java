...
public class MultiTex implements Renderable {
    ...
    /**
     * Constructs a new <tt>MultiTex</tt> object using the textures identified
     * in <tt>textures</tt>. The index of the textures in the list will be the
     * texture unit that the texture is bound to.
     * 
     * @param textures
     *            a list of paths to the textures to use.
     * @throws SlickException
     *             If <tt>textures.size()</tt> is greater than the maximum
    ...
    /**
     * Sets the colour of a given corner. Note that this will have an effect
     * only if: the fixed pixel pipeline is being used; or the applied shader
     * takes the vertex colour into account.
     * 
     * @param corner
     * @param c
     */
    ...
    /**
     * Sets the colour of all four corners.
     * 
     * @see setColour
     * @param c
     */
